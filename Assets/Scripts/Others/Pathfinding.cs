...
public class Pathfinding : MonoBehaviour
{
    ...
    public void Setup(int width, int height, float cellSize, int floorAmount) {
        ...
        for (int floor = 0; floor < floorAmount; floor++) {
            gridSystemList.Add(new GridSystem<PathNode>(width, height, cellSize, floor, LevelGrid.FLOOR_HEIGHT,
        ...
        foreach (Transform pathfindingLinkTransform in pathfindingLinkContainer) {
            if (pathfindingLinkTransform.TryGetComponent(out PathfindingLinkMonoBehaviour pathfindingMonoBehaviour)) {
                pathfindingLinkList.Add(pathfindingMonoBehaviour.GetPathfindingLink());
            }
        }
        //pathfindingLinkList.Add(new PathfindingLink {
        //    gridPositionA = new GridPosition(1, 4, 0),
        //    gridPositionB = new GridPosition(1, 5, 1)
        //});
        //pathfindingLinkList.Add(new PathfindingLink {
    ...
    private List<PathNode> GetNeighbourList(PathNode currentNode)
    {
        ...
        //    // Grab below and above neighbour;
    ...
    private List<GridPosition> GetPathfindingLinkConnectedGridPositionList(GridPosition gridPosition) {
        // List of grid positions that are linked to this gridPosition (passed param)
